...
if [[ $(hostname) == lilith.local ]]; then
  export MERCURY_DIR="$HOME/Projects/mercury"
else
  export MERCURY_DIR="$HOME/Projects"
fi
...
export VISUAL=nvim
export EDITOR=nvim
export CDPATH=".:$HOME:$HOME/Projects:$MERCURY_DIR"
...
export BUNDLE_LOCAL__MERCURY_SSO_AUTH0="$MERCURY_DIR/mercury-analytics-sso-auth0"
export BUNDLE_LOCAL__URI_S3="$MERCURY_DIR/uri_s3"
